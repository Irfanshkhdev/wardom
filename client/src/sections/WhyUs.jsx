    ...
    <Section id="why-us" className="bg-[#FAFAFA] border-y border-[#E5E7EB]">
      <Container>
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl border border-[#E5E7EB] bg-gradient-to-br from-white to-[#FAFAFA] p-8 sm:p-12 lg:p-16 shadow-sm max-w-5xl mx-auto"
        >
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-sm leading-relaxed text-[#555555] sm:text-base">
