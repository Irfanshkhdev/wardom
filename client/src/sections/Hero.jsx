...
import { ArrowUpRight, Sparkles, Layout, Globe, Code2, Dumbbell, Utensils } from 'lucide-react'
...
const RECENT_WORK_CARDS = [
  ...
  },
  {
    ...
    highlights: ['Interactive skills showcase', 'Cinematic dark theme', 'Project case studies', 'Instant booking contact flow'],
  ...
  },
  {
    ...
    subtitle: 'Cafe & Restaurant Platform',
    metric: 'Direct Table Reservations',
    description: 'Direct table reservation engine, contactless digital menu, and local Google Maps optimization.',
    highlights: ['Direct WhatsApp booking', 'QR menu', 'Google Maps sync', 'Zero commission'],
  ...
  },
  {
    ...
    title: 'Pulse Fitness',
    tag: 'Mobile App',
    clientType: 'Gym & Athletic',
    subtitle: 'Gym Member App',
    metric: 'HIIT Class Pass System',
    description: 'HIIT & class schedule booking platform, auto-renew membership portals, and personal trainer booking.',
    highlights: ['Class pass generation', 'Stripe recurring billing', 'Trainer booking', 'Native feel'],
    stack: ['React Native', 'FastAPI', 'Stripe'],
    images: [
...
export default function Hero() {
  ...
  const marqueeCards = [...RECENT_WORK_CARDS, ...RECENT_WORK_CARDS]
  ...
  return (
    <section id="top" className="relative overflow-hidden bg-white pt-32 pb-16 lg:pt-40 lg:pb-24">
      ...
      {/* Automatic Horizontal Scrolling Marquee Gallery for Recent Work */}
      <div className="mt-14 overflow-hidden border-y border-[#E5E7EB] bg-[#FAFAFA] py-8 relative">
            ...
            {marqueeCards.map((card, i) => {
              ...
              return (
                <div
                  ...
                  className="minimal-card relative overflow-hidden p-5 flex flex-col justify-between w-[280px] sm:w-[320px] h-[280px] shrink-0 cursor-pointer group bg-white border border-[#E5E7EB] hover:border-[#5F8D3B] transition-all shadow-sm"
                >
                  <div>
                  ...
                  <div className="mt-6 rounded-xl border border-[#E5E7EB] bg-[#FAFAFA] p-3.5 flex items-center justify-between">
